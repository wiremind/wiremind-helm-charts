...
```
./scripts/update_crds.sh -r Altinity/clickhouse-operator -b 0.25.6 --folder deploy/helm/clickhouse-operator/crds -o charts/clickhouse-operator-crds/templates/
```
