...
You can update the entire chart using the script from root dir `./scripts/update_charts.sh -r bitnami/charts -a redis --path bitnami --wiremind-image <image_tag>`
