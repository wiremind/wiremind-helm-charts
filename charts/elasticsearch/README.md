...
* Install it: `helm install elasticsearch wiremind/elasticsearch`
...
* Install it: `helm install elasticsearch ./wiremind-helm-charts/elasticsearch --set imageTag=8.5.1`
...
| `topologySpreadConstraints`        | Configurable [topologySpreadConstraints](https://kubernetes.io/docs/concepts/scheduling-eviction/topology-spread-constraints/) for pod scheduling.                                                                                                      | `[]`                                             |
