...
```
./scripts/update_crds.sh -r giantswarm/silence-operator/ -b v0.21.0 --folder helm/silence-operator/templates/crds.yml -o charts/silence-operator-crds/templates/
```
