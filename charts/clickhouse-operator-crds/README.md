...
```
./scripts/update_crds.sh -r Altinity/clickhouse-operator -b release-0.27.3 --folder deploy/helm/clickhouse-operator/crds -o charts/clickhouse-operator-crds/templates/
```
